...
export namespace Prisma {
  ...
  */
  ...
  export class Prisma__UserClient<T, Null = never> implements PrismaPromise<T> {
    ...
    tokens<T extends TokenFindManyArgs = {}>(args?: Subset<T, TokenFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Token>| Null>, PrismaPromise<Array<TokenGetPayload<T>>| Null>>;
  ...
  export type TokenGetPayload<
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'User' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof Token ? Token[P] : never
  } 
    : Token
  : Token
